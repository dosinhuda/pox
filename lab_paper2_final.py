...
def topology():
    ...
    net.addLink(full_node1, agw1, bw=100, delay ='0.02ms', loss=0) 
    net.addLink(full_node1, agw2, bw=100, delay ='0.02ms', loss=0) 
    net.addLink(full_node1, agw3, bw=100, delay ='0.02ms', loss=0) 
